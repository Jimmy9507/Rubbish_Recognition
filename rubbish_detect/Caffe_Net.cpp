...
cv::Scalar colortable[classNum] = { cv::Scalar(0, 0, 0), cv::Scalar(0, 0, 125),
cv::Scalar(0, 125, 125), cv::Scalar(125, 125, 125), cv::Scalar(125, 0, 0), cv::Scalar(125, 125, 0) };
*/

//string classname[classNum] = { "aeroplane", "banana", "leaf", "boat", "bottle", "bus", "car", "cat", "chair", "cow",
...
string classname[classNum] = { "apple","cigarette","apple","banana","plasticbag","bottle" };
